...
The FDM project operates an open contributor model where anyone is
...
The following applies to code changes to the FDM project, and is not to be
confused with overall FDM Network Protocol consensus changes.

Whether a pull request is merged into FDM rests with the project merge
...
Patches that change FDM consensus rules are considerably more involved than
...
Where a patch set proposes to change the FDM consensus, it must have been
...
The project leader is the release manager for each FDM release.
