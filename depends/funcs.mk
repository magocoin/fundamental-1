...
$(foreach dep,$($(1)_all_dependencies),$(eval $(1)_build_id_dFDM+=$(dep)-$($(dep)_version)-$($(dep)_recipe_hash)))
$(eval $(1)_build_id_long:=$(1)-$($(1)_version)-$($(1)_recipe_hash)-$(release_type) $($(1)_build_id_dFDM) $($($(1)_type)_id_string))
...
# broken down into small stFDM so that each part is done for all packages
