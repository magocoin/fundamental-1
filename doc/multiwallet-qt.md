...
In order to support loading of multiple wallets in FDM-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is FDM.cpp.
...
Changes to FDM.cpp
----------------------
FDM.cpp is the entry point into FDM-qt, and as such, will require some minor modifications to provide hooks for
