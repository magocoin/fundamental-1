...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("FDM FDM-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  FDM-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded FDM transaction") + "\n" +
                               "  FDM-tx [options] -create [commands]   " + _("Create hex-encoded FDM transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded FDM transaction
