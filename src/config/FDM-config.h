/* src/config/FDM-config.h.  Generated from FDM-config.h.in by configure.  */
/* src/config/FDM-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "FDMad.network"

/* Define to the full name of this package. */
#define PACKAGE_NAME "FDM Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "FDM Core 1.0.0"
