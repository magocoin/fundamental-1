...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* FDM features */
        {"FDM", "masternode", &masternode, true, true, false},
        {"FDM", "listmasternodes", &listmasternodes, true, true, false},
        {"FDM", "getmasternodecount", &getmasternodecount, true, true, false},
        {"FDM", "masternodeconnect", &masternodeconnect, true, true, false},
        {"FDM", "masternodecurrent", &masternodecurrent, true, true, false},
        {"FDM", "masternodedebug", &masternodedebug, true, true, false},
        {"FDM", "startmasternode", &startmasternode, true, true, false},
        {"FDM", "createmasternodekey", &createmasternodekey, true, true, false},
        {"FDM", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"FDM", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"FDM", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"FDM", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"FDM", "getmasternodescores", &getmasternodescores, true, true, false},
        {"FDM", "mnbudget", &mnbudget, true, true, false},
        {"FDM", "preparebudget", &preparebudget, true, true, false},
        {"FDM", "submitbudget", &submitbudget, true, true, false},
        {"FDM", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"FDM", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"FDM", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"FDM", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"FDM", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"FDM", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"FDM", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"FDM", "checkbudgets", &checkbudgets, true, true, false},
        {"FDM", "mnsync", &mnsync, true, true, false},
        {"FDM", "spork", &spork, true, true, false},
        {"FDM", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"FDM", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use FDMd, or the -server option to FDM-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> FDM-cli " + methodname + " " + args + "\n";
}
