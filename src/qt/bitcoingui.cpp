...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a FDM address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and FDM: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About FDM"), this);
    aboutAction->setStatusTip(tr("Show information about FDM"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for FDM"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your FDM addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified FDM addresses"));
    ...
    openAction->setStatusTip(tr("Open a FDM: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the FDM help message to get a list with possible FDM command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("FDM client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FDM network", "", count));
}
...
{
    QString strTitle = tr("FDM"); // default title
