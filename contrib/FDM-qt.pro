...
RESOURCES += src/qt/FDM.qrc src/qt/FDM_locale.qrc

TRANSLATIONS += src/qt/locale/FDM_bg.ts \
                src/qt/locale/FDM_de.ts \
                src/qt/locale/FDM_en.ts \
                src/qt/locale/FDM_es.ts \
                src/qt/locale/FDM_fi.ts \
                src/qt/locale/FDM_fr.ts \
                src/qt/locale/FDM_it.ts \
                src/qt/locale/FDM_ja.ts \
                src/qt/locale/FDM_pl.ts \
                src/qt/locale/FDM_pt.ts \
                src/qt/locale/FDM_ru.ts \
                src/qt/locale/FDM_sk.ts \
                src/qt/locale/FDM_sv.ts \
                src/qt/locale/FDM_vi.ts \
                src/qt/locale/FDM_zh_CN.ts \
                src/qt/locale/FDM_zh_TW.ts
